...
export function Model(props) {
    ...
    useLayoutEffect(()=>{
      ...
      tl.to(group.current, {
        scrollTrigger: {
          ...
          start: "top center", // When element reaches center of viewport
          onEnter: () => actions["car1turn1"]?.play(),
          onLeaveBack: () => actions["car1turn1"]?.stop(),
        },
      });
  ...
  return (
    <group position={[-10,-2,-1]} ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          name="Plane005"
          castShadow
